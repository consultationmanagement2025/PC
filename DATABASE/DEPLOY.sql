-- PCMS SINGLE DEPLOY FILE (app schema + LGU-2 integration)
-- Import this ONE file in phpMyAdmin. Database: pc_db
-- =============================================================
...
CREATE DATABASE IF NOT EXISTS `cons_pc_db`
...
-- =============================================================
-- 12) SEED DATA (DEFAULT ADMIN ACCOUNTS)
-- Login Email / Username 1: admin@pcms.local or admin
-- Login Email / Username 2: consultationmanagement2025@gmail.com
...
(
    'System Administrator',
    'System Administrator',
    'consultationmanagement2025',
    'consultationmanagement2025@gmail.com',
    '$2y$10$9EngZTEJPwSvW9o0nxaIS.NtpNWJXJzZkI08uIt32YyBhKSKTEbqi',
    'admin',
    'active',
    'verified'
...
-- ============================================================================
-- LGU-2 CROSS-SYSTEM INTEGRATION TABLES (all 5 systems)
-- Tokens are seeded automatically on first /api/v1/* request.
...
CREATE TABLE IF NOT EXISTS `integration_inbox` (
  ...
  KEY `idx_event_processed` (`event_type`, `processed`),
  KEY `idx_external_ref` (`external_ref`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ============================================================================
-- LGU-2 INTEGRATION - PCMS (database: pc_db)
-- ============================================================================
...
ALTER TABLE `consultations`
  ...
  ADD COLUMN IF NOT EXISTS `phms_hearing_id` int(11) DEFAULT NULL,
