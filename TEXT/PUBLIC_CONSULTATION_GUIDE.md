...
2. **`system-template-full.php`** - Admin dashboard for managing consultations
...
### Admin Side (Back-end)
1. Admin logs in to **`system-template-full.php`**
...
### For Admins
1. Go to `system-template-full.php`
...
1. **Admin Navigation**: Go to `system-template-full.php`
2. **Fill Form**:
   ```
   Title: Notice of Public Consultation - Proposed Schedule of Market Values (SMV)
   Category: Budget & Finance
