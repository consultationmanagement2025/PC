        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="public/index.php">My Portal</a>
                    </li>
                    <li class="nav-item">
                        ...
                        let html = `
                            ...
                            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
                                ...
                                <div style="background: #f5f5f5; padding: 1rem; border-radius: 8px;">
                                    ...
                                    <p style="margin: 0.5rem 0 0 0; font-weight: 700;">${new Date(consultation.start_date).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</p>
                                </div>
                                <div style="background: #f5f5f5; padding: 1rem; border-radius: 8px;">
                                    <small style="color: #666; font-weight: 600;">End Date</small>
                                    <p style="margin: 0.5rem 0 0 0; font-weight: 700;">${new Date(consultation.end_date).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</p>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 1.5rem;">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                                    ...
                                    <div style="text-align: center; padding: 1rem; background: #f5f5f5; border-radius: 8px;">
                                        <div style="font-size: 1.5rem; font-weight: 700; color: #4CAF50;">${new Date(consultation.created_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</div>
