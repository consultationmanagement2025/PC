...
<body class="bg-gray-100 min-h-screen">
    ...
    <script>
        ...
        function surveyMetaRow(s) {
            const starts = s.starts_at ? new Date(s.starts_at).toLocaleString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' }) : 'No start limit';
            const ends = s.ends_at ? new Date(s.ends_at).toLocaleString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' }) : 'No end limit';
            return `
