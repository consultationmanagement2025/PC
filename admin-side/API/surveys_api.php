...
if (!$is_public_action && $current_role !== 'admin' && $current_role !== 'administrator' && $current_role !== 'super admin' && $current_role !== 'superadmin' && !in_array($current_role, ['staff', 'resource person', 'resource_person'], true)) {
