...
async function openAnnouncementDetail(annId) {
    try {
        ...
        if (json.success) {
            ...
            document.getElementById('ann-detail-meta').textContent = 'Posted by ' + ann.admin_user + ' · ' + new Date(ann.created_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' });
...
async function loadAdminPosts() {
    ...
    try {
        ...
        posts.forEach(p => {
            ...
            const createdDate = new Date(p.created_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' });
...
async function loadAdminAnnouncements() {
    ...
    try {
        ...
        anns.forEach(a => {
            ...
            const createdDate = new Date(a.created_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' });
            const createdTime = new Date(a.created_at).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' });
