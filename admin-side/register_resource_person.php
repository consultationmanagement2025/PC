...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($expertise_areas) || empty($qualifications) || empty($department)) {
        ...
        if ($checkStmt->num_rows > 0) {
            ...
            $insertStmt = $conn->prepare("INSERT INTO users (fullname, email, google_id, google_token, role, verification_status, expertise_areas, qualifications, department, phone, status) VALUES (?, ?, ?, ?, 'resource person', 'pending', ?, ?, ?, ?, 'active')");
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full p-8">
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="flex gap-4">
                ...
                <a href="index.php" class="flex-1 bg-gray-200 text-gray-700 py-3 px-6 rounded-lg font-medium hover:bg-gray-300 transition text-center">
                    Cancel
                </a>
            </div>
        </form>
