                                    ...
                                    <tbody>
                                        ...
                                        <?php else: foreach ($consultationForms as $c): ?>
                                            ...
                                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="p-3 text-xs text-gray-600"><?php if (!empty($c['start_date'])) echo htmlspecialchars(date('M d, Y', strtotime($c['start_date']))); else echo '-'; ?></td>

                                                <td class="p-3 text-xs text-gray-600"><?php if (!empty($c['end_date'])) echo htmlspecialchars(date('M d, Y', strtotime($c['end_date']))); else echo '-'; ?></td>
