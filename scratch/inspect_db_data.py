...
with open(r"c:\xampp\htdocs\CAP101\PC\scratch\check_db_tables.php", "w") as f:
    f.write(php_code)

res = subprocess.run(["C:\\xampp\\php\\php.exe", r"c:\xampp\htdocs\CAP101\PC\scratch\check_db_tables.php"], capture_output=True, text=True)
print(res.stdout)
print(res.stderr)
