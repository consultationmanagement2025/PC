...
with open(r"c:\xampp\htdocs\CAP101\PC\scratch\check_vf.php", "w") as f:
    f.write(php_code)

res = subprocess.run(["C:\\xampp\\php\\php.exe", r"c:\xampp\htdocs\CAP101\PC\scratch\check_vf.php"], capture_output=True, text=True)
