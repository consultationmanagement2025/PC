                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="flex items-center space-x-1 md:space-x-4">
                            ...
                            <div class="relative">
                                <button id="profile-btn" type="button" onclick="(function(e){e&&e.preventDefault&&e.preventDefault();e&&e.stopPropagation&&e.stopPropagation();var dd=document.getElementById('profile-dropdown');if(dd)dd.classList.toggle('hidden');if(typeof toggleProfileDropdown==='function'){try{toggleProfileDropdown();}catch(err){}}})(event); return false;" aria-haspopup="true" class="flex items-center space-x-3 p-2 hover:bg-gray-100 rounded-lg transition">
