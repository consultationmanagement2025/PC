...
<head>
    ...
    <title>Create Account - PCMS | City of Valenzuela</title>
    ...
    <div id="termsModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
        <div class="bg-white rounded-xl max-w-2xl w-full my-8 max-h-[80vh] overflow-y-auto">
            ...
            <div class="p-6 md:p-8 text-gray-700 text-sm md:text-base leading-relaxed space-y-4">
                ...
                <p>By registering for and using the Public Consultation Management Portal (PCMS), you agree to comply with and be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the platform.</p>
                ...
                <p>All content provided on the PCMS, including documents, ordinances, and consultation materials, remains the property of the City Government of Valenzuela. You may view and download content for personal, non-commercial use only.</p>
                ...
                <p>The City Government of Valenzuela shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the PCMS or inability to access the platform.</p>
