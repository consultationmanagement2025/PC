        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-800 text-white p-8 rounded-lg shadow-lg">
                ...
                <div class="flex justify-between items-start mb-6">
                    ...
                    <div class="flex gap-2">
                        <button onclick="openCreateConsultationModal('feedback')" class="btn-primary flex items-center gap-2 bg-white text-red-600 hover:bg-red-50">
                            <i class="bi bi-plus-lg"></i> Add Consultation
                        </button>
                        <button onclick="openCreateConsultationModal('survey')" class="btn-primary flex items-center gap-2 bg-white text-blue-600 hover:bg-blue-50">
